    ...
    <div class="modalMain">
        ...
        <div class="modalItem">Upload img</div>
            ...
            <div class="modalValue" id="fileButton">
                ...
                <input type="file" name="file-1[]"  accept="image/x-png, image/gif, image/jpeg" id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple="">
